...
<li style="margin-bottom: 15px">Sheng Yang, Weisi Lin, Guosheng Lin, <b>Qiuping Jiang</b>, Zichuan Liu, <b>"Progressive Self-Guided Loss for Salient Object Detection,"</b> <i>IEEE Transactions on Image Processing (TIP)</i>, revision, 2021. </li>
<li style="margin-bottom: 15px">Xiongli Chai, Feng Shao, <b>Qiuping Jiang</b>, Xiangchao Meng, Yo-Sung Ho, <b>"Monocular and Binocular Interactions Oriented Deformable Convolutional Networks for Blind Quality Assessment of Stereoscopic Omnidirectional Images,"</b> <i>IEEE Transactions on Circuits and Systems for Video Technology (TCSVT)</i>, major revision, 2021. </li> </ol> </div>
